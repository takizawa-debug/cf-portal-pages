...
for (const line of lines) {
    ...
    statements.push(`  ('${id}', '${name_ja}', '${name_en}', '${name_zh}', '${harvest_season}', '${harvest_category}', '${lineage}', '${origin}', '${image}', '', '${summary}', '${desc}', ${orderNum})`);
}
...
if (statements.length > 0) {
    const sql = "DROP TABLE IF EXISTS apple_varieties;\n" +
                ...
                ");\n\n" +
                "INSERT INTO apple_varieties (id, name_ja, name_en, name_zh, harvest_season, harvest_category, lineage, origin, official_image_url, yokai_card_url, summary, description, display_order) VALUES \n" + statements.join(",\n") + ";\n";
