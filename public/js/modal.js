...
window.lzModal = (function () {
  ...
  var injectStyles = function () {
    ...
    style.textContent = [
      ...
      '.lz-lead-strong { font-weight: 700; font-size: clamp(1.5rem, 3.5vw, 2.1rem); line-height: 1.7; color: #222; }',
      '.lz-txt { font-size: clamp(1.3rem, 3vw, 1.8rem); color: #444; line-height: 2.0; letter-spacing: 0.03em; white-space: pre-wrap; }',
      ...
      '.lz-info-label { font-weight: 700; color: #999; font-size: 1.2rem; text-transform: uppercase; letter-spacing: 0.05em; display: flex; align-items: center; gap: 6px; }',
      '.lz-info-label::before { content: ""; display: inline-block; width: 6px; height: 6px; background: #e0d5ce; border-radius: 50%; }',
      '.lz-info-val { color: #333; font-size: clamp(1.3rem, 3vw, 1.75rem); line-height: 1.7; font-weight: 500; }',
