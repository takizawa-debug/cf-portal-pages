...
window.lzModal = (function () {
  ...
  var injectStyles = function () {
    ...
    style.textContent = [
      ...
      '.lz-mt { margin: 0; font-weight: 700; font-size: clamp(1.7rem, 4vw, 2.8rem); color: #a82626; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; line-height: 1.4; }',
      '.lz-actions { display: flex; gap: 8px; align-items: center; }',
      '.lz-btn { display: inline-flex; align-items: center; justify-content: center; gap: 8px; background: #fdfaf8; border: none; border-radius: 999px; padding: 12px 20px; cursor: pointer; color: #a82626; font-weight: 700; font-size: 1.4rem; line-height: 1; transition: all 0.2s ease; }',
      '.lz-btn:hover { background: #feebeb; color: #cf3a3a; transform: scale(1.02); }',
      '.lz-btn svg { width: 22px; height: 22px; stroke-width: 2.5; }',
      ...
      '.lz-m-lang-btn { padding: 8px 20px; border-radius: 999px; font-size: 1.3rem; font-weight: 700; cursor: pointer; border: none; background: transparent; color: #666; transition: all .2s; }',
      ...
      '.lz-modal-right { flex: 1; padding: 24px 32px 40px; display: flex; flex-direction: column; gap: 28px; }',
      '@media(max-width:768px) { .lz-modal-right { padding: 20px 24px 32px; gap: 24px; } }',
      '.lz-lead-strong { font-weight: 700; font-size: clamp(1.6rem, 3.5vw, 2.3rem); line-height: 1.7; color: #222; }',
      '.lz-txt { font-size: clamp(1.4rem, 3vw, 2.0rem); color: #444; line-height: 2.0; letter-spacing: 0.03em; white-space: pre-wrap; }',
      ...
      '.lz-info-list { display: flex; flex-direction: column; gap: 20px; margin-top: 10px; }',
      '.lz-info-item { display: flex; flex-direction: column; gap: 8px; padding: 16px 20px; background: #fcfcfc; border-radius: 12px; border: 1px solid #f0f0f0; }',
      '.lz-info-label { font-weight: 700; color: #999; font-size: 1.3rem; text-transform: uppercase; letter-spacing: 0.05em; display: flex; align-items: center; gap: 6px; }',
      '.lz-info-label::before { content: ""; display: inline-block; width: 6px; height: 6px; background: #e0d5ce; border-radius: 50%; }',
      '.lz-info-val { color: #333; font-size: clamp(1.4rem, 3vw, 1.9rem); line-height: 1.7; font-weight: 500; }',
