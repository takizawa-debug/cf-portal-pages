...
window.lzSearchEngine = (function () {
  ...
  var injectSearchStyles = function () {
    ...
    style.textContent = [
      ...
      '.lz-s-title { font-size: clamp(1.6rem, 4vw, 2.4rem) !important; font-weight: 600 !important; color: #333 !important; margin-bottom: 12px !important; border-left: 6px solid #27ae60 !important; padding-left: 12px !important; line-height: 1.3 !important; display: block !important; }',
      ...
      '.lz-s-name { font-size: clamp(1.3rem, 3.5vw, 1.9rem); font-weight: 500; color: #cf3a3a; margin-bottom: 2px; line-height: 1.3; font-family: "Zen Kaku Gothic New", "Zen Gothic", "Helvetica Neue", Arial, "Hiragino Kaku Gothic ProN", "Hiragino Sans", Meiryo, sans-serif; }',
      '.lz-s-body { font-size: clamp(1.1rem, 2.5vw, 1.5rem); color: #666; line-height: 1.5; -webkit-line-clamp: 2; display: -webkit-box; -webkit-box-orient: vertical; overflow: hidden; }',
      '.lz-s-cat { font-size: clamp(1.0rem, 2vw, 1.2rem); background: #27ae60; color: #fff; padding: 2px 8px; border-radius: 4px; font-weight: 600; display: inline-block; }',
